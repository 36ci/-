...
public class CartBuyMedicineActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < dbData.size(); i++) {
            ...
            packages[i][0] = strData[0];  // 药品名称
            packages[i][1] = "药品";  // 类型
            packages[i][2] = "已添加到购物车";  // 状态
            packages[i][3] = "待结算";  // 备注
            packages[i][4] = "价格: " + strData[1] + " 元";
            totalAmount = totalAmount + Float.parseFloat(strData[1]);
        }
        tvTotal.setText("总价: " + totalAmount + " 元");
